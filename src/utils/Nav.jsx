...
const Nav = () => {
    ...
    return (
        <motion.nav initial={{ opacity: 0 }} animate={{ opacity: 100 }} transition={{ duration: 0.7 }} className='w-full h-full pb-10 lg:h-auto px-10 py-7 text-white absolute z-20 top-0 left-0 font-sharp' style={active ? { position: "fixed" } : {}}>
